// Sample array of restaurant objects
const restaurants = [
    {
        "image": "second",
        "name": "Fusion Feast",
...
function generateRestaurantCards(restaurants){
    ...
    restaurants.forEach(restaurant =>{
        ...
        // 1: Image
        // 2: Card Content: div
        //    i: Card Header (Name of res and rating)
        //    ii: Card footer( Dish and price)
        //    iii: Card Location(Location res and distance)
        ...
        dish.textContent = restaurant.food_type;

        const price = document.createElement('span');
        price.textContent = "₹"+restaurant.price_for_two+" For Two";

        card_footer.appendChild(dish);
...
rating.addEventListener('click',()=>{
    ...
    const result = restaurants.filter(restaurant=> restaurant.rating>4.5);
    document.getElementById('root').replaceChildren();
    generateRestaurantCards(result);
})

const Alcohol = document.getElementById("Alcohol");
Alcohol.addEventListener('click',()=>{
    
    const result = restaurants.filter(restaurant=> restaurant.alcohol);
    document.getElementById('root').replaceChildren();
    generateRestaurantCards(result);
})
...
// Handle the Filters button click
document.getElementById("Filters").addEventListener("click", () => {
    const filterPopup = document.getElementById("filterPopup");
    filterPopup.classList.remove("hidden"); // Show the filter options
});

// Close the filter popup when clicking the close button
document.getElementById("closeFilter").addEventListener("click", () => {
    const filterPopup = document.getElementById("filterPopup");
    filterPopup.classList.add("hidden"); // Hide the filter options
});



// document.getElementById("applyFilter").addEventListener("click", () => {
//     const selectedFilter = document.querySelector('input[name="filterOption"]:checked');
//     if (selectedFilter) {
...
//                 break;
//             case "highLow":
//                 sortedRestaurants = [...restaurants].sort((a, b) => b.price_for_two - a.price_for_two);
//                 break;
//             case "costLowHigh":
//                 sortedRestaurants = [...restaurants].sort((a, b) => a.price_for_two - b.price_for_two);
//                 break;
//             case "distance":
//                 sortedRestaurants = [...restaurants].sort((a, b) => a.distance_from_Customer_house - b.distance_from_Customer_house);
//                 break;
//             default:
//                 sortedRestaurants = restaurants; // No filter selected
//         }
        
//         document.getElementById('root').replaceChildren();
//         generateRestaurantCards(sortedRestaurants); // Update the restaurant list
//         document.getElementById("filterPopup").classList.add("hidden"); // Close the popup after applying filter
//     }
// });
